...
//region SECTION: Constructor
     ...
     */
    public function __construct(HttpSecurity $httpSecurity, TokenStorageInterface $tokenStorage, CsrfTokenManagerInterface $csrfTokenManager, EventDispatcherInterface $eventDispatcher, Configuration $configuration, LdapProviderInterface $ldapProvider)
    {
